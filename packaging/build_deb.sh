...
# dependency .debs from /prebuilt, then builds pairs_bumper and copies the .deb to /output.
#   PAIRS deps (build order, supplied from /prebuilt): pairs_msgs pairs_lib
set -eo pipefail
ROS_DISTRO_NAME="noetic"; OS_NAME="ubuntu"; OS_VERSION="focal"
source "/opt/ros/${ROS_DISTRO_NAME}/setup.bash"
set -u

LOCAL_RULES="/src/pairs_bumper/packaging/rosdep/pairs.yaml"
