...
#include <pairs_lib/dynamic_reconfigure_mgr.h>
...
#include <pairs_bumper/BumperConfig.h>
#include <pairs_msgs/ObstacleSectors.h>
#include <pairs_msgs/Histogram.h>

// shortcut type to the dynamic reconfigure manager template instance
typedef pairs_lib::DynamicReconfigureMgr<pairs_bumper::BumperConfig> drmgr_t;
...
namespace pairs_bumper
{
  ...
  using ObstacleSectors = pairs_msgs::ObstacleSectors;
  using Histogram = pairs_msgs::Histogram;
  ...
  public:
    ...
    void onInit()
    {
      ...
      pairs_lib::ParamLoader pl(nh, m_node_name);
      ...
      m_obstacles_pub = pairs_lib::PublisherHandler<ObstacleSectors>(nh, "obstacle_sectors", 1);
      m_processed_depthmap_pub = pairs_lib::PublisherHandler<sensor_msgs::Image>(nh, "processed_depthmap", 1);
      m_depthmap_hist_pub = pairs_lib::PublisherHandler<Histogram>(nh, "depthmap_histogram", 1);
      m_lidar3d_processed = pairs_lib::PublisherHandler<sensor_msgs::PointCloud2>(nh, "lidar3d_processed", 1);
      ...
      m_tfm = std::make_unique<pairs_lib::Transformer>(m_node_name);
  ...
  private:
    ...
    pairs_lib::SubscribeHandler<sensor_msgs::Image> m_depthmap_sh;
    pairs_lib::SubscribeHandler<sensor_msgs::CameraInfo> m_depth_cinfo_sh;
    pairs_lib::SubscribeHandler<pc_t> m_lidar3d_sh;
    pairs_lib::SubscribeHandler<sensor_msgs::LaserScan> m_lidar2d_sh;
    pairs_lib::SubscribeHandler<sensor_msgs::Range> m_lidar1d_down_sh;
    pairs_lib::SubscribeHandler<sensor_msgs::Range> m_lidar1d_up_sh;

    tf2_ros::Buffer m_tf_buffer;
    std::unique_ptr<tf2_ros::TransformListener> m_tf_listener_ptr;

    pairs_lib::PublisherHandler<ObstacleSectors> m_obstacles_pub;
    pairs_lib::PublisherHandler<sensor_msgs::Image> m_processed_depthmap_pub;
    pairs_lib::PublisherHandler<Histogram> m_depthmap_hist_pub;
    pairs_lib::PublisherHandler<sensor_msgs::PointCloud2> m_lidar3d_processed;
...
PLUGINLIB_EXPORT_CLASS(pairs_bumper::Bumper, nodelet::Nodelet)
